...
namespace ParticleUniverse
{
    ...
    */
	class _ParticleUniverseExport EntityRendererTokens : public ITokenInitialiser
	{
		protected:
		...
		protected:
			...
			class EntityOrientationTypeToken : public IToken {virtual void parse(ParticleScriptParser* parser);} mEntityOrientationTypeToken;
	};
