...
namespace ParticleUniverse
{
    ...
    */
	class _ParticleUniverseExport OnTimeObserverTokens : public ITokenInitialiser
	{
		public:
		...
		protected:
			...
			class TimeToken : public IToken {virtual void parse(ParticleScriptParser* parser);} mTimeToken;
			class SinceStartSystemToken : public IToken {virtual void parse(ParticleScriptParser* parser);} mSinceStartSystemToken;
	};
