...
namespace ParticleUniverse
{
    ...
    */
	class _ParticleUniverseExport OnEventFlagObserverTokens : public ITokenInitialiser
	{
		public:
		...
		protected:
			...
			class EventFlagToken : public IToken {virtual void parse(ParticleScriptParser* parser);} mEventFlagToken;
	};
