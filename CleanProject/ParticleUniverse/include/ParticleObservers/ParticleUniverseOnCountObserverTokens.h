...
namespace ParticleUniverse
{
    ...
    */
	class _ParticleUniverseExport OnCountObserverTokens : public ITokenInitialiser
	{
		public:
		...
		protected:
			...
			class CountToken : public IToken {virtual void parse(ParticleScriptParser* parser);} mCountToken;
	};
