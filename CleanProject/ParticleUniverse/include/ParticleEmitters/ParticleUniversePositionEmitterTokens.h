...
namespace ParticleUniverse
{
    ...
    */
	class _ParticleUniverseExport PositionEmitterTokens : public ITokenInitialiser
	{
		public:
		...
		protected:
			...
			class RandomizedToken : public IToken {virtual void parse(ParticleScriptParser* parser);} mRandomizedToken;
