...
namespace ParticleUniverse
{
    ...
    */
	class _ParticleUniverseExport ParticleRendererFactory : public ITokenInitialiser
	{
	    protected:
	        ...
	        */
			...
			{
				ParticleRenderer* particleRenderer = new T();
	...
	public:
	        ...
	        */
			...
			/** Delete a renderer.
	        */
			void destroyRenderer (ParticleRenderer* renderer){if (renderer) delete renderer;};
	};
