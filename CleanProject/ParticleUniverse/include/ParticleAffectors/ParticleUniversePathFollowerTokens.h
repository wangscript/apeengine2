...
namespace ParticleUniverse
{
    ...
    */
	class _ParticleUniverseExport PathFollowerTokens : public ITokenInitialiser
	{
		public:
		...
		protected:
			...
			*/
			class PointToken : public IToken {virtual void parse(ParticleScriptParser* parser);} mPointToken;
	};
