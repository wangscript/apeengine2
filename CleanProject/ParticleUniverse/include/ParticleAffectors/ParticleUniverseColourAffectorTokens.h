...
namespace ParticleUniverse
{
    ...
    */
	class _ParticleUniverseExport ColourAffectorTokens : public ITokenInitialiser
	{
		public:
		...
		protected:
			...
			*/
			class TimeColourToken : public IToken {virtual void parse(ParticleScriptParser* parser);} mTimeColourToken;
			class ColourOperationToken : public IToken {virtual void parse(ParticleScriptParser* parser);} mColourOperationToken;
	};
