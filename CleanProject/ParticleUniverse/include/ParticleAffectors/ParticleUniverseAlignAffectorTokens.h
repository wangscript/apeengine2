...
namespace ParticleUniverse
{
    ...
    */
	class _ParticleUniverseExport AlignAffectorTokens : public ITokenInitialiser
	{
		public:
		...
		protected:
			...
			*/
			class ResizeToken : public IToken {virtual void parse(ParticleScriptParser* parser);} mResizeToken;
	};
