...
namespace wraps
{
	...
	public:
		BaseItemBox(const std::string & _layout, MyGUI::WidgetPtr _parent) : BaseLayout(_layout, _parent)
		{
			...
			mBoxItems->eventMouseButtonDoubleClick = MyGUI::newDelegate(this, &BaseItemBox::notifyItemDoubleClick);
	...
	private:
		...
		void notifyItemDoubleClick(MyGUI::WidgetPtr _sender) {
			eventItemBoxDoubleClick(_sender);
		}
	...
	public:
		...
		MyGUI::delegates::CDelegate1<MyGUI::WidgetPtr> eventItemBoxDoubleClick;
