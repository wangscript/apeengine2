...
namespace ParticleUniverse
{
    ...
    */
	class _ParticleUniverseExport ParticleEmitterFactory : public ITokenInitialiser
	{
	    protected:
	        ...
	        */
			...
			{
				ParticleEmitter* particleEmitter = new T();
	...
	public:
	        ...
	        */
			...
			/** Delete an emitter 
	        */
			void destroyEmitter (ParticleEmitter* emitter){delete emitter;};
	};
