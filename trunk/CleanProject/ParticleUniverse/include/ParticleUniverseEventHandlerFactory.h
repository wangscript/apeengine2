...
namespace ParticleUniverse
{
    ...
    */
	class _ParticleUniverseExport ParticleEventHandlerFactory : public ITokenInitialiser
	{
	    protected:
	        ...
	        */
			...
			{
				ParticleEventHandler* particleEventHandler = new T();
	...
	public:
	        ...
	        */
			void destroyEventHandler (ParticleEventHandler* eventHandler){delete eventHandler;};
	};
