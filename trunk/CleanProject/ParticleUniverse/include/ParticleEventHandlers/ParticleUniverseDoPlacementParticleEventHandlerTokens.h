...
namespace ParticleUniverse
{
    ...
    */
	class _ParticleUniverseExport DoPlacementParticleEventHandlerTokens : public ITokenInitialiser
	{
		public:
		...
		protected:
			...
			class ForceEmitterToken : public IToken {virtual void parse(ParticleScriptParser* parser);} mForceEmitterToken;
			class NumberOfParticlesToken : public IToken {virtual void parse(ParticleScriptParser* parser);} mNumberOfParticlesToken;
	};
