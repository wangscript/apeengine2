...
namespace ParticleUniverse
{
    ...
    */
	class _ParticleUniverseExport CameraDependencyTokens : public ITokenInitialiser
	{
		public:
		...
		protected:
			...
			class ThresholdToken : public IToken {virtual void parse(ParticleScriptParser* parser);} mThresholdToken;
			class IncreaseToken : public IToken {virtual void parse(ParticleScriptParser* parser);} mIncreaseToken;
	};
