...
namespace ParticleUniverse
{
    ...
    */
	class _ParticleUniverseExport VertexEmitterTokens : public ITokenInitialiser
	{
		public:
		...
		protected:
			...
			class SegmentsToken : public IToken {virtual void parse(ParticleScriptParser* parser);} mSegmentsToken;
			class IterationsToken : public IToken {virtual void parse(ParticleScriptParser* parser);} mIterationsToken;
