...
namespace ParticleUniverse
{
    ...
    */
	class _ParticleUniverseExport JetAffectorTokens : public ITokenInitialiser
	{
		public:
		...
		protected:
			...
			*/
			class AccelerationToken : public IToken {virtual void parse(ParticleScriptParser* parser);} mAccelerationToken;
	};
