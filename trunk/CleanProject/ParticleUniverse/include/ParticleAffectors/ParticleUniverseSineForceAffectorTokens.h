...
namespace ParticleUniverse
{
    ...
    */
	class _ParticleUniverseExport SineForceAffectorTokens : public ITokenInitialiser
	{
		public:
		...
		protected:
			...
			class FrequencyMinToken : public IToken {virtual void parse(ParticleScriptParser* parser);} mFrequencyMinToken;
			class FrequencyMaxToken : public IToken {virtual void parse(ParticleScriptParser* parser);} mFrequencyMaxToken;
	};
