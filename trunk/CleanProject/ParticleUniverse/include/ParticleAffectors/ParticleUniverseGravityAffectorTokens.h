...
namespace ParticleUniverse
{
    ...
    */
	class _ParticleUniverseExport GravityAffectorTokens : public ITokenInitialiser
	{
		public:
		...
		protected:
			...
			*/
			class GravityToken : public IToken {virtual void parse(ParticleScriptParser* parser);} mGravityToken;
	};
