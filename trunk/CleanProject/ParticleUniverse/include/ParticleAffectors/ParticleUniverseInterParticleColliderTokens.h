...
namespace ParticleUniverse
{
    ...
    */
	class _ParticleUniverseExport InterParticleColliderTokens : public ITokenInitialiser
	{
		public:
		...
		protected:
			...
			*/
			class AdjustmentToken : public IToken {virtual void parse(ParticleScriptParser* parser);} mAdjustmentToken;
			class CollisionResponseToken : public IToken {virtual void parse(ParticleScriptParser* parser);} mCollisionResponseToken;
	};
