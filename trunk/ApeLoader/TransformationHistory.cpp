...
TransformationHistoryCell::TransformationHistoryCell(unsigned long t, const Ogre::Vector3& pos, const Ogre::Vector3& vel, const Ogre::Quaternion& quat  ) :
time(t),
velocity(vel),
position(pos),
orientation(quat)
...
void TransformationHistory::Init(unsigned long maxWriteInterval, unsigned long maxHistoryTime)
{
...
void TransformationHistory::Write(const Ogre::Vector3 &position, const Ogre::Vector3 &velocity, const Ogre::Quaternion &orientation, unsigned long curTimeMS)
{
	if (history.Size()==0)
	{
...
void TransformationHistory::Overwrite(const Ogre::Vector3 &position, const Ogre::Vector3 &velocity, const Ogre::Quaternion &orientation, unsigned long when)
{
